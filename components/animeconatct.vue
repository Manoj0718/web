...
.glow::before {
  ...
  position: absolute;
  left: -2px;
  text-shadow: -5px 0 rgb(255, 0, 255);
  overflow: hidden;
  top: 0;
...
@keyframes noise-1 {
  ...
  23.3333333333% {
    clip-path: inset(47px 0 33px 0);
  }
  26.6666666667% {
    clip-path: inset(64px 0 35px 0);
  }
  30% {
  ...
  70% {
    clip-path: inset(42px 0 7px 0);
  }
  73.3333333333% {
    clip-path: inset(7px 0 42px 0);
  }
  76.6666666667% {
    clip-path: inset(48px 0 21px 0);
  }
  80% {
    clip-path: inset(37px 0 63px 0);
  }
  83.3333333333% {
    clip-path: inset(37px 0 13px 0);
  }
  86.6666666667% {
    clip-path: inset(73px 0 18px 0);
  }
  90% {
...
@keyframes noise-2 {
  ...
  26.6666666667% {
    clip-path: inset(2px 0 46px 0);
  }
  30% {
    clip-path: inset(65px 0 14px 0);
  }
  33.3333333333% {
    clip-path: inset(85px 0 8px 0);
  }
  36.6666666667% {
    clip-path: inset(15px 0 79px 0);
  }
  40% {
    clip-path: inset(1px 0 18px 0);
  }
  43.3333333333% {
  ...
  60% {
    clip-path: inset(66px 0 5px 0);
  }
  63.3333333333% {
    clip-path: inset(36px 0 27px 0);
  }
  66.6666666667% {
    clip-path: inset(13px 0 25px 0);
  }
  70% {
  ...
  80% {
    clip-path: inset(2px 0 13px 0);
  }
  83.3333333333% {
    clip-path: inset(5px 0 33px 0);
  }
  86.6666666667% {
    clip-path: inset(48px 0 15px 0);
  }
  90% {
